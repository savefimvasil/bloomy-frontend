...
- Name: admin/verification.spec.ts >> Admin – contractor verification flow >> expanding a document card shows document details
- Location: e2e/admin/verification.spec.ts:55:7
