...
Received string:  "http://localhost:3001/register/profile?email=hw-reg-1785537419585%40e2e.test"
Timeout: 15000ms

Call log:
  - Expect "toHaveURL" with timeout 15000ms
    33 × locator resolved to <html lang="en" class="h-full antialiased">…</html>
       - unexpected value "http://localhost:3001/register/profile?email=hw-reg-1785537419585%40e2e.test"
...
- main:
  ...
  - paragraph: For hw-reg-1785537419585@e2e.test
  - text: Name
  - textbox "Name":
  ...
  - text: Send me tips, updates, and occasional promotions from Bloomy Email not verified — please verify your email first
