...
- Name: auth/register-homeowner.spec.ts >> Homeowner registration flow @smoke >> post-condition – user exists in DB with role=homeowner
- Location: e2e/auth/register-homeowner.spec.ts:81:7
