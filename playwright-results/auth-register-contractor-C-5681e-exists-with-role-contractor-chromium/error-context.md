...
- Name: auth/register-contractor.spec.ts >> Contractor registration flow >> post-condition – user exists with role=contractor
- Location: e2e/auth/register-contractor.spec.ts:80:7
