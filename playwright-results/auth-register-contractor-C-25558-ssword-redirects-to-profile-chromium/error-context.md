...
- Name: auth/register-contractor.spec.ts >> Contractor registration flow >> step 4 – set password redirects to profile
- Location: e2e/auth/register-contractor.spec.ts:54:7
