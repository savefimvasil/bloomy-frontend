...
- Name: auth/register-contractor.spec.ts >> Contractor registration flow >> step 1 – submit email redirects to verify
- Location: e2e/auth/register-contractor.spec.ts:21:7
